            ...
            if isinstance(dep, Future):
                try:
                    ...
                    if hasattr(dep, 'task_record'):
                        ...
                        # or a type check for AppFuture (and DataFuture?)
                        # or a defaulting get attribute call?
                        # see multiple instances of this in following code too which should be modified the same way
                        d_tmp = cast(Any, dep)
